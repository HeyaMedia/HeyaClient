...
use self::crossfeed::{Crossfeed, CrossfeedPreset};
...
impl DspChain {
    ...
    pub fn set_sample_rate(&mut self, rate: u32) {
        ...
        self.crossfeed.set_sample_rate(rate);
    ...
    pub fn set_crossfeed(&mut self, enabled: bool, preset: CrossfeedPreset) {
        use traits::DspBlock;
        self.crossfeed.set_preset(preset);
        self.crossfeed.set_enabled(enabled);
    }

    pub fn set_crossfeed_before_eq(&mut self, before: bool) {
        self.crossfeed_before_eq = before;
        self.reset();
    }
